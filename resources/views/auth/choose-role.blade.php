...
@section("content")
    <div class="w-100 text-center position-relative">
        ...
        <div class="container h-100">
            ...
            <form action="{{ route("choose-role.user") }}" method="POST"
                  class="mt-5 row text-center mx-auto w-75 gap-5 text-black" style="width: fit-content">
                @csrf
                <div class="col p-5 bg-white rounded-3 p-4">
                    <div class="my-4">
                        <img src="{{ storage_asset("/Login/find-experience-asset.svg") }}" alt="Find an Experience"
                             class="img-fluid"/>
                    </div>
                    <div class="mb-4 ">
                        Find an Experience
                    </div>
                    <button type="submit" name="role" value="participant" class="btn btn-outline-dark mb-4">View Events
                        around you
                    </button>
                </div>
                <div class="col p-5 bg-white rounded-3 p-4">
                    <div class="my-4">
                         <img src="{{ storage_asset("/Login/organize-events-asset.svg") }}" alt="Find an Experience"
                             class="img-fluid"/>
                    </div>
                    <div class="mb-4 ">
                        Organize Events
