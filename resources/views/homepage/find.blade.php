    ...
    <div class="d-flex flex-col gap-5">
        ...
        <div class="col-md-9">
            <div class="row gap-4 row-cols-1 row-cols-md-2 row-cols-lg-3">
                ...
                <a class="card p-3" style="width: 18rem;" href="{{route('event.show', $event)}}">
                    <img class="card-img-top rounded-2 mb-3" style="height: 12rem;" src="{{$event->banner_image}}"
                         alt="Card image cap">
                    <h5 class="card-title fw-bold" style="text-overflow: ellipsis; overflow: hidden; white-space: nowrap">{{$event->name}}</h5>
                    <div class="card-text bg-yellow-primary px-2 rounded-3"
                         style="width: fit-content"> {{$event->category->name}} </div>
                    <div class="py-2 col">
                        <div class="d-flex flex-row gap-4" style="place-items: center; ">
